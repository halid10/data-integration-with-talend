...
public class jOdsSousCategorie implements TalendJob {
	static {System.setProperty("TalendJob.log", "jOdsSousCategorie.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(jOdsSousCategorie.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_S4CK0Cr6Ee61k8eCTkiFFw", "0.1");
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tSetGlobalVar_1{
                    ...
                    log4jParamters_tSetGlobalVar_1.append("Parameters:");
                            log4jParamters_tSetGlobalVar_1.append("VARIABLES" + " = " + "[{VALUE="+("\"ICOM_*_SOUS_CATEGORIE.csv\"")+", KEY="+("\"masque_fichier\"")+"}, {VALUE="+("\"SOUS_CATEGORIE\"")+", KEY="+("\"nom_flux\"")+"}]");
...
insertRejectStruct insertReject = new insertRejectStruct();
	...
	currentComponent="tDBOutput_2";
			...
			cLabel="\"ODS_SOUS_CATEGORIE\"<br>         <b>tDBOutput_2</b>";
		
			runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,0,0,"insertSousCategorie");
		...
		int tos_count_tDBOutput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"ODS_SOUS_CATEGORIE\"");
                        log4jParamters_tDBOutput_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_2", "\"ODS_SOUS_CATEGORIE\"<br>         <b>tDBOutput_2</b>", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
			}
...
int count_tDBOutput_2=0;
        ...
        sb_tDBOutput_2.append("INSERT INTO \"").append(tableName_tDBOutput_2).append("\" (\"CD_SOUS_CATEGORIE\",\"LB_SOUS_CATEGORIE\",\"CD_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?)");
 ...
 */
	...
	currentComponent="tDBOutput_3";
			...
			cLabel="\"ODS_SOUS_CATEGORIE\"<br>          <b>tDBOutput_3</b>";
		...
		int tos_count_tDBOutput_3 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_3{
                    ...
                    log4jParamters_tDBOutput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_3.append(" | ");
                            log4jParamters_tDBOutput_3.append("TABLE" + " = " + "\"ODS_SOUS_CATEGORIE\"");
                        log4jParamters_tDBOutput_3.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_3", "\"ODS_SOUS_CATEGORIE\"<br>          <b>tDBOutput_3</b>", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
			}
 ...
 */
	...
	currentComponent="tDBOutput_6";
			...
			cLabel="\"ODS_SOUS_CATEGORIE\"<br>          <b>tDBOutput_6</b>";
		
			runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,0,0,"insertNewValueSousCategorie");
		...
		int tos_count_tDBOutput_6 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_6{
                    ...
                    log4jParamters_tDBOutput_6.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_6.append(" | ");
                            log4jParamters_tDBOutput_6.append("TABLE" + " = " + "\"ODS_SOUS_CATEGORIE\"");
                        log4jParamters_tDBOutput_6.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_6", "\"ODS_SOUS_CATEGORIE\"<br>          <b>tDBOutput_6</b>", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
			}
...
int count_tDBOutput_6=0;
        ...
        sb_tDBOutput_6.append("INSERT INTO \"").append(tableName_tDBOutput_6).append("\" (\"CD_SOUS_CATEGORIE\",\"LB_SOUS_CATEGORIE\",\"CD_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?)");
 ...
 */
	...
	currentComponent="tMap_5";
			...
			runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,0,0,"VerifCategorie");
...
// # Lookup's keys initialization
		int count_VerifCategorie_tMap_5 = 0;
...
// # Outputs initialization
				int count_insertSousCategorie_tMap_5 = 0;
...
updateBlCurrentStruct updateBlCurrent_tmp = new updateBlCurrentStruct();
				int count_insertNewValueSousCategorie_tMap_5 = 0;
 ...
 */
	...
	currentComponent="tDBOutput_1";
			...
			runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,0,0,"CategorieManquant");
...
// ###############################
// # Outputs initialization
				int count_VerifCategorie_tMap_2 = 0;
				
VerifCategorieStruct VerifCategorie_tmp = new VerifCategorieStruct();
				int count_CategorieManquant_tMap_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tUniqRow_1{
                    ...
                    log4jParamters_tUniqRow_1.append("Parameters:");
                            log4jParamters_tUniqRow_1.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("true")+", SCHEMA_COLUMN="+("CD_SOUS_CATEGORIE")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("false")+", SCHEMA_COLUMN="+("LB_SOUS_CATEGORIE")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("false")+", SCHEMA_COLUMN="+("CD_CATEGORIE")+"}, {CASE_SENSITIVE="+("false")+", KEY_ATTRIBUTE="+("false")+", SCHEMA_COLUMN="+("NUM_LIGNE")+"}]");
                        log4jParamters_tUniqRow_1.append(" | ");
 ...
 */
	...
	currentComponent="tFilterRow_2";
			...
			runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,0,0,"SousCategories");
...
// ###############################
// # Outputs initialization
				int count_SousCategories_tMap_1 = 0;
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
			...
			cLabel="       SOUS_CATEGORIE<br>  <b>tFileInputDelimited_1</b>";
		...
		int tos_count_tFileInputDelimited_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("CD_SOUS_CATEGORIE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LB_SOUS_CATEGORIE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CD_CATEGORIE")+"}]");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tFileInputDelimited_1", "       SOUS_CATEGORIE<br>  <b>tFileInputDelimited_1</b>", "tFileInputDelimited");
				talendJobLogProcess(globalMap);
			}
...
if(row1 != null) { 
	...
	currentComponent="tMap_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tFileInputDelimited_1","       SOUS_CATEGORIE<br>  <b>tFileInputDelimited_1</b>","tFileInputDelimited","tMap_1","Ajout N\u00B0Ligne<br>      <b>tMap_1</b>","tMap"
...
log.debug("tMap_1 - Outputting the record " + count_SousCategories_tMap_1 + " of the output table 'SousCategories'.");
...
if(SousCategories != null) { 
	...
	currentComponent="tFilterRow_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"SousCategories","tMap_1","Ajout N\u00B0Ligne<br>      <b>tMap_1</b>","tMap","tFilterRow_2","Donn\u00E9es non nulles<br>      <b>tFilterRow_2</b>","tFilterRow"
    			...
    			if(log.isTraceEnabled()){
    				log.trace("SousCategories - " + (SousCategories==null? "": SousCategories.toLogString()));
    			}
...
log.debug("tMap_2 - Outputting the record " + count_VerifCategorie_tMap_2 + " of the output table 'VerifCategorie'.");
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
count_CategorieManquant_tMap_2++;
...
log.debug("tMap_2 - Outputting the record " + count_CategorieManquant_tMap_2 + " of the output table 'CategorieManquant'.");
...
if(VerifCategorie != null) { 
	...
	currentComponent="tMap_5";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"VerifCategorie","tMap_2","        V\u00E9rification d\u00E9pendance<br>                    <b>tMap_2</b>","tMap","tMap_5","  Mapping<br>   <b>tMap_5</b>","tMap"
    			...
    			if(log.isTraceEnabled()){
    				log.trace("VerifCategorie - " + (VerifCategorie==null? "": VerifCategorie.toLogString()));
    			}
...
count_insertNewValueSousCategorie_tMap_5++;
...
log.debug("tMap_5 - Outputting the record " + count_insertNewValueSousCategorie_tMap_5 + " of the output table 'insertNewValueSousCategorie'.");
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_5 ) {
count_insertSousCategorie_tMap_5++;
...
log.debug("tMap_5 - Outputting the record " + count_insertSousCategorie_tMap_5 + " of the output table 'insertSousCategorie'.");
...
if(insertSousCategorie != null) { 
	...
	currentComponent="tDBOutput_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"insertSousCategorie","tMap_5","  Mapping<br>   <b>tMap_5</b>","tMap","tDBOutput_2","\"ODS_SOUS_CATEGORIE\"<br>         <b>tDBOutput_2</b>","tPostgresqlOutput"
    			...
    			if(log.isTraceEnabled()){
    				log.trace("insertSousCategorie - " + (insertSousCategorie==null? "": insertSousCategorie.toLogString()));
    			}
...
if(updateBlCurrent != null) { 
	...
	currentComponent="tDBOutput_3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"updateBlCurrent","tMap_5","  Mapping<br>   <b>tMap_5</b>","tMap","tDBOutput_3","\"ODS_SOUS_CATEGORIE\"<br>          <b>tDBOutput_3</b>","tPostgresqlOutput"
...
if(insertNewValueSousCategorie != null) { 
	...
	currentComponent="tDBOutput_6";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"insertNewValueSousCategorie","tMap_5","  Mapping<br>   <b>tMap_5</b>","tMap","tDBOutput_6","\"ODS_SOUS_CATEGORIE\"<br>          <b>tDBOutput_6</b>","tPostgresqlOutput"
    			...
    			if(log.isTraceEnabled()){
    				log.trace("insertNewValueSousCategorie - " + (insertNewValueSousCategorie==null? "": insertNewValueSousCategorie.toLogString()));
    			}
...
if(CategorieManquant != null) { 
	...
	currentComponent="tDBOutput_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"CategorieManquant","tMap_2","        V\u00E9rification d\u00E9pendance<br>                    <b>tMap_2</b>","tMap","tDBOutput_1","\"ODS_REJET\"<br><b>tDBOutput_1</b>","tPostgresqlOutput"
    			...
    			if(log.isTraceEnabled()){
    				log.trace("CategorieManquant - " + (CategorieManquant==null? "": CategorieManquant.toLogString()));
    			}
...
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'SousCategories': " + count_SousCategories_tMap_1 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row1",2,0,
			 			"tFileInputDelimited_1","       SOUS_CATEGORIE<br>  <b>tFileInputDelimited_1</b>","tFileInputDelimited","tMap_1","Ajout N\u00B0Ligne<br>      <b>tMap_1</b>","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
    ...
    globalMap.put("tFilterRow_2_NB_LINE_REJECT", nb_line_reject_tFilterRow_2);
    	...
    	log.info("tFilterRow_2 - Processed records count:" + nb_line_tFilterRow_2 + ". Matched records count:" + nb_line_ok_tFilterRow_2 + ". Rejected records count:" + nb_line_reject_tFilterRow_2 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"SousCategories",2,0,
...
// ###############################      
				log.debug("tMap_2 - Written records count in the table 'VerifCategorie': " + count_VerifCategorie_tMap_2 + ".");
				log.debug("tMap_2 - Written records count in the table 'CategorieManquant': " + count_CategorieManquant_tMap_2 + ".");
...
// ###############################      
				log.debug("tMap_5 - Written records count in the table 'insertSousCategorie': " + count_insertSousCategorie_tMap_5 + ".");
				log.debug("tMap_5 - Written records count in the table 'updateBlCurrent': " + count_updateBlCurrent_tMap_5 + ".");
				log.debug("tMap_5 - Written records count in the table 'insertNewValueSousCategorie': " + count_insertNewValueSousCategorie_tMap_5 + ".");





			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"VerifCategorie",2,0,
...
globalMap.put("tDBOutput_2_ERROR_MESSAGE",e_tDBOutput_2.getMessage());
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"insertSousCategorie",2,0,
			 			"tMap_5","  Mapping<br>   <b>tMap_5</b>","tMap","tDBOutput_2","\"ODS_SOUS_CATEGORIE\"<br>         <b>tDBOutput_2</b>","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_3=nb_line_rejected_tDBOutput_3 + rejectedCount_tDBOutput_3;
        ...
        globalMap.put("tDBOutput_3_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_3);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"updateBlCurrent",2,0,
			 			"tMap_5","  Mapping<br>   <b>tMap_5</b>","tMap","tDBOutput_3","\"ODS_SOUS_CATEGORIE\"<br>          <b>tDBOutput_3</b>","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
...
globalMap.put("tDBOutput_6_ERROR_MESSAGE",e_tDBOutput_6.getMessage());
	...
	nb_line_rejected_tDBOutput_6=nb_line_rejected_tDBOutput_6 + rejectedCount_tDBOutput_6;
        ...
        globalMap.put("tDBOutput_6_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_6);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"insertNewValueSousCategorie",2,0,
			 			"tMap_5","  Mapping<br>   <b>tMap_5</b>","tMap","tDBOutput_6","\"ODS_SOUS_CATEGORIE\"<br>          <b>tDBOutput_6</b>","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"CategorieManquant",2,0,
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDie_1{
                    ...
                    log4jParamters_tDie_1.append("Parameters:");
                            log4jParamters_tDie_1.append("MESSAGE" + " = " + "\"Le répertoire \"+TalendDate.getDate(\"YYYYMMDD\")+ \" ne contient pas de fichier SousCategorie. Veuillez déposer le fichier du jour et relancer l'intégration\" ");
 ...
 */
	...
	System.err.println("Le répertoire "+TalendDate.getDate("YYYYMMDD")+ " ne contient pas de fichier SousCategorie. Veuillez déposer le fichier du jour et relancer l'intégration" );
		...
		log.error("tDie_1 - The die message: "+"Le répertoire "+TalendDate.getDate("YYYYMMDD")+ " ne contient pas de fichier SousCategorie. Veuillez déposer le fichier du jour et relancer l'intégration" );
	...
	status = "failure";
		...
		if(enableLogStash) {
			talendJobLog.addJobExceptionMessage(currentComponent, cLabel, "Le répertoire "+TalendDate.getDate("YYYYMMDD")+ " ne contient pas de fichier SousCategorie. Veuillez déposer le fichier du jour et relancer l'intégration" , null);
			talendJobLogProcess(globalMap);
		}
 ...
 */
	...
	currentComponent="tAdvancedHash_row7";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row7","tDBInput_2","\"ODS_SOUS_CATEGORIE\"<br>           <b>tDBInput_2</b>","tPostgresqlInput","tAdvancedHash_row7","tAdvancedHash_row7","tAdvancedHash"
...
tHash_Lookup_row7.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row7",2,0,
			 			"tDBInput_2","\"ODS_SOUS_CATEGORIE\"<br>           <b>tDBInput_2</b>","tPostgresqlInput","tAdvancedHash_row7","tAdvancedHash_row7","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
    ...
    public static void main(String[] args){
        ...
        int exitCode = jOdsSousCategorieClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'jOdsSousCategorie' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'jOdsSousCategorie' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_S4CK0Cr6Ee61k8eCTkiFFw");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-07-28T12:58:45.500270100Z");
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'jOdsSousCategorie' - Started.");
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'jOdsSousCategorie' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     578124 characters generated by Talend Cloud Data Fabric 
 *     on the July 28, 2023 at 2:58:45 PM CEST
 ************************************************************************************************/