...
public class jDwhProduit implements TalendJob {
	static {System.setProperty("TalendJob.log", "jDwhProduit.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(jDwhProduit.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_kqaywCx4Ee69aJNa5n3Vgg", "0.1");
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tDBConnection_2";
			...
			cLabel="     Connexion DWH<br><b>tDBConnection_2</b>";
		...
		int tos_count_tDBConnection_2 = 0;
                ...
                class BytesLimit65535_tDBConnection_2{
                    ...
                    log4jParamters_tDBConnection_2.append("Parameters:");
                        ...
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("HOST" + " = " + "context.serverName");
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PORT" + " = " + "context.port");
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("DBNAME" + " = " + "context.database");
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("SCHEMA_DB" + " = " + "context.schema_dwh");
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("USER" + " = " + "context.utilisateur");
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PASS" + " = " + String.valueOf(routines.system.PasswordEncryptUtil.encryptPassword(context.password)).substring(0, 4) + "...");     
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("USE_SHARED_CONNECTION" + " = " + "true");
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("SHARED_CONNECTION_NAME" + " = " + "\"VENTE_DWH\"");
                        log4jParamters_tDBConnection_2.append(" | ");
                            log4jParamters_tDBConnection_2.append("PROPERTIES" + " = " + "context.additionalParam");
                        log4jParamters_tDBConnection_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBConnection_2", "     Connexion DWH<br><b>tDBConnection_2</b>", "tPostgresqlConnection");
				talendJobLogProcess(globalMap);
			}
...
public static class updateBlCurrentStruct implements routines.system.IPersistableRow<updateBlCurrentStruct> {
    ...
    public String loopKey;
				...
				public Boolean ID_DIM_PRODUITIsNullable(){
				    return false;
				}
				public Boolean ID_DIM_PRODUITIsKey(){
				    return true;
				}
				public Integer ID_DIM_PRODUITLength(){
				    return 10;
				}
				public Integer ID_DIM_PRODUITPrecision(){
				    return 0;
				}
				public String ID_DIM_PRODUITDefault(){
				
					return "nextval('\"VENTE_DWH\".\"DIM_PRODUIT_ID_DIM_PRODUIT_seq\"'::regclass)";
				
				}
				public String ID_DIM_PRODUITComment(){
				
				    return "";
				
				}
				public String ID_DIM_PRODUITPattern(){
				
					return "";
				
				}
				public String ID_DIM_PRODUITOriginalDbColumnName(){
				
					return "ID_DIM_PRODUIT";
				...
				public Boolean DT_MISE_A_JOURIsNullable(){
				    return true;
				}
				public Boolean DT_MISE_A_JOURIsKey(){
				    return false;
				}
				public Integer DT_MISE_A_JOURLength(){
				    return 29;
				}
				public Integer DT_MISE_A_JOURPrecision(){
				    return 6;
				}
				public String DT_MISE_A_JOURDefault(){
				
					return null;
				
				}
				public String DT_MISE_A_JOURComment(){
				
				    return "";
				
				}
				public String DT_MISE_A_JOURPattern(){
				
					return "dd-MM-yyyy HH:mm:ss";
				
				}
				public String DT_MISE_A_JOUROriginalDbColumnName(){
    ...
    public String toString() {
        ...
        public String toLogString(){
        	StringBuilder sb = new StringBuilder();
        				...
        				sb.append(ID_DIM_PRODUIT);
        			
        			sb.append("|");
        		
        				if(DT_MISE_A_JOUR == null){
        					sb.append("<null>");
        				}else{
            				sb.append(DT_MISE_A_JOUR);
            			}
...
insertNewProductsStruct insertNewProducts = new insertNewProductsStruct();
	...
	currentComponent="tDBOutput_1";
		...
		int tos_count_tDBOutput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_1{
                    ...
                    log4jParamters_tDBOutput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_1.append(" | ");
                            log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"DIM_PRODUIT\"");
                        log4jParamters_tDBOutput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_1", "\"DIM_PRODUIT\"", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
			}
...
int count_tDBOutput_1=0;
        ...
        sb_tDBOutput_1.append("INSERT INTO \"").append(tableName_tDBOutput_1).append("\" (\"CD_PRODUIT\",\"NOM_PRODUIT\",\"CD_SOUS_CATEGORIE\",\"LB_SOUS_CATEGORIE\",\"CD_CATEGORIE\",\"LB_CATEGORIE\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?)");
 ...
 */
	...
	currentComponent="tDBOutput_2";
		...
		int tos_count_tDBOutput_2 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_2{
                    ...
                    log4jParamters_tDBOutput_2.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_2.append(" | ");
                            log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"DIM_PRODUIT\"");
                        log4jParamters_tDBOutput_2.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_2", "\"DIM_PRODUIT\"", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
			}
 ...
 */
	...
	currentComponent="tDBOutput_3";
			...
			runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,0,0,"insertNewProducts");
		...
		int tos_count_tDBOutput_3 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBOutput_3{
                    ...
                    log4jParamters_tDBOutput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBOutput_3.append(" | ");
                            log4jParamters_tDBOutput_3.append("TABLE" + " = " + "\"DIM_PRODUIT\"");
                        log4jParamters_tDBOutput_3.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBOutput_3", "\"DIM_PRODUIT\"", "tPostgresqlOutput");
				talendJobLogProcess(globalMap);
			}
...
int count_tDBOutput_3=0;
        ...
        sb_tDBOutput_3.append("INSERT INTO \"").append(tableName_tDBOutput_3).append("\" (\"CD_PRODUIT\",\"NOM_PRODUIT\",\"CD_SOUS_CATEGORIE\",\"LB_SOUS_CATEGORIE\",\"CD_CATEGORIE\",\"LB_CATEGORIE\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?)");
...
// # Outputs initialization
				int count_insertProduit_tMap_2 = 0;
...
updateBlCurrentStruct updateBlCurrent_tmp = new updateBlCurrentStruct();
				int count_insertNewProducts_tMap_2 = 0;
 ...
 */
	...
	currentComponent="tMap_1";
			...
			cLabel="R\u00E9cup\u00E8re LB<br>    <b>tMap_1</b>";
		...
		int tos_count_tMap_1 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tMap_1", "R\u00E9cup\u00E8re LB<br>    <b>tMap_1</b>", "tMap");
				talendJobLogProcess(globalMap);
			}
 ...
 */
	...
	currentComponent="tDBInput_1";
			...
			cLabel="\"ODS_PRODUIT\"<br>  <b>tDBInput_1</b>";
		...
		int tos_count_tDBInput_1 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    \\\"\"+context.schema_ods+\"\\\".\\\"ODS_PRODUIT\\\".\\\"CD_PRODUIT\\\",    \\\"\"+context.schema_ods+\"\\\".\\\"ODS_PRODUIT\\\".\\\"NOM_PRODUIT\\\",    \\\"\"+context.schema_ods+\"\\\".\\\"ODS_PRODUIT\\\".\\\"PRIX_ACHAT_PRODUIT\\\",    \\\"\"+context.schema_ods+\"\\\".\\\"ODS_PRODUIT\\\".\\\"PRIX_VENTE_PRODUIT\\\",    \\\"\"+context.schema_ods+\"\\\".\\\"ODS_PRODUIT\\\".\\\"CD_SOUS_CATEGORIE\\\",    \\\"\"+context.schema_ods+\"\\\".\\\"ODS_PRODUIT\\\".\\\"LB_NOM_FICHIER\\\",    \\\"\"+context.schema_ods+\"\\\".\\\"ODS_PRODUIT\\\".\\\"DT_INSERTION\\\",    \\\"\"+context.schema_ods+\"\\\".\\\"ODS_PRODUIT\\\".\\\"BL_LIGNE_ACTIVE\\\",    \\\"\"+context.schema_ods+\"\\\".\\\"ODS_PRODUIT\\\".\\\"LB_JOB_NAME\\\" FROM \\\"\"+context.schema_ods+\"\\\".\\\"ODS_PRODUIT\\\"  WHERE \\\"BL_LIGNE_ACTIVE\\\"=1;  \"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("CD_PRODUIT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("NOM_PRODUIT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("PRIX_ACHAT_PRODUIT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("PRIX_VENTE_PRODUIT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CD_SOUS_CATEGORIE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LB_NOM_FICHIER")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DT_INSERTION")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("BL_LIGNE_ACTIVE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LB_JOB_NAME")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_1", "\"ODS_PRODUIT\"<br>  <b>tDBInput_1</b>", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
			}
 ...
 */
	...
	currentComponent="tMap_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row1","tDBInput_1","\"ODS_PRODUIT\"<br>  <b>tDBInput_1</b>","tPostgresqlInput","tMap_1","R\u00E9cup\u00E8re LB<br>    <b>tMap_1</b>","tMap"
...
if(produits != null) { 
	...
	currentComponent="tMap_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"produits","tMap_1","R\u00E9cup\u00E8re LB<br>    <b>tMap_1</b>","tMap","tMap_2","     Mapping<br>      <b>tMap_2</b>","tMap"
...
count_insertNewProducts_tMap_2++;
...
log.debug("tMap_2 - Outputting the record " + count_insertNewProducts_tMap_2 + " of the output table 'insertNewProducts'.");
...
log.debug("tMap_2 - Outputting the record " + count_insertProduit_tMap_2 + " of the output table 'insertProduit'.");
...
if(insertProduit != null) { 
	...
	currentComponent="tDBOutput_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"insertProduit","tMap_2","     Mapping<br>      <b>tMap_2</b>","tMap","tDBOutput_1","\"DIM_PRODUIT\"","tPostgresqlOutput"
...
if(updateBlCurrent != null) { 
	...
	currentComponent="tDBOutput_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"updateBlCurrent","tMap_2","     Mapping<br>      <b>tMap_2</b>","tMap","tDBOutput_2","\"DIM_PRODUIT\"","tPostgresqlOutput"
...
if(insertNewProducts != null) { 
	...
	currentComponent="tDBOutput_3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"insertNewProducts","tMap_2","     Mapping<br>      <b>tMap_2</b>","tMap","tDBOutput_3","\"DIM_PRODUIT\"","tPostgresqlOutput"
    			...
    			if(log.isTraceEnabled()){
    				log.trace("insertNewProducts - " + (insertNewProducts==null? "": insertNewProducts.toLogString()));
    			}
...
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'produits': " + count_produits_tMap_1 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row1",2,0,
			 			"tDBInput_1","\"ODS_PRODUIT\"<br>  <b>tDBInput_1</b>","tPostgresqlInput","tMap_1","R\u00E9cup\u00E8re LB<br>    <b>tMap_1</b>","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
...
// ###############################      
				log.debug("tMap_2 - Written records count in the table 'insertProduit': " + count_insertProduit_tMap_2 + ".");
				log.debug("tMap_2 - Written records count in the table 'updateBlCurrent': " + count_updateBlCurrent_tMap_2 + ".");
				log.debug("tMap_2 - Written records count in the table 'insertNewProducts': " + count_insertNewProducts_tMap_2 + ".");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"produits",2,0,
			 			"tMap_1","R\u00E9cup\u00E8re LB<br>    <b>tMap_1</b>","tMap","tMap_2","     Mapping<br>      <b>tMap_2</b>","tMap","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_1=nb_line_rejected_tDBOutput_1 + rejectedCount_tDBOutput_1;
        ...
        globalMap.put("tDBOutput_1_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_1);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"insertProduit",2,0,
			 			"tMap_2","     Mapping<br>      <b>tMap_2</b>","tMap","tDBOutput_1","\"DIM_PRODUIT\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"updateBlCurrent",2,0,
			 			"tMap_2","     Mapping<br>      <b>tMap_2</b>","tMap","tDBOutput_2","\"DIM_PRODUIT\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
...
globalMap.put("tDBOutput_3_ERROR_MESSAGE",e_tDBOutput_3.getMessage());
	...
	nb_line_rejected_tDBOutput_3=nb_line_rejected_tDBOutput_3 + rejectedCount_tDBOutput_3;
        ...
        globalMap.put("tDBOutput_3_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_3);
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"insertNewProducts",2,0,
			 			"tMap_2","     Mapping<br>      <b>tMap_2</b>","tMap","tDBOutput_3","\"DIM_PRODUIT\"","tPostgresqlOutput","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
	...
	currentComponent="tDBInput_2";
			...
			cLabel="\"ODS_SOUS_CATEGORIE\"<br>           <b>tDBInput_2</b>";
		...
		int tos_count_tDBInput_2 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_2", "\"ODS_SOUS_CATEGORIE\"<br>           <b>tDBInput_2</b>", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
			}
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tDBInput_2","\"ODS_SOUS_CATEGORIE\"<br>           <b>tDBInput_2</b>","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash"
...
tHash_Lookup_row2.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row2",2,0,
			 			"tDBInput_2","\"ODS_SOUS_CATEGORIE\"<br>           <b>tDBInput_2</b>","tPostgresqlInput","tAdvancedHash_row2","tAdvancedHash_row2","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
	...
	currentComponent="tDBInput_3";
			...
			cLabel="     \"DIM_PRODUIT\"<br>       <b>tDBInput_3</b>";
		...
		int tos_count_tDBInput_3 = 0;
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_3{
                    ...
                    log4jParamters_tDBInput_3.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("QUERY" + " = " + "\"SELECT    \\\"\"+context.schema_dwh+\"\\\".\\\"DIM_PRODUIT\\\".\\\"ID_DIM_PRODUIT\\\",    \\\"\"+context.schema_dwh+\"\\\".\\\"DIM_PRODUIT\\\".\\\"CD_PRODUIT\\\",    \\\"\"+context.schema_dwh+\"\\\".\\\"DIM_PRODUIT\\\".\\\"NOM_PRODUIT\\\",    \\\"\"+context.schema_dwh+\"\\\".\\\"DIM_PRODUIT\\\".\\\"CD_SOUS_CATEGORIE\\\",    \\\"\"+context.schema_dwh+\"\\\".\\\"DIM_PRODUIT\\\".\\\"LB_SOUS_CATEGORIE\\\",    \\\"\"+context.schema_dwh+\"\\\".\\\"DIM_PRODUIT\\\".\\\"CD_CATEGORIE\\\",    \\\"\"+context.schema_dwh+\"\\\".\\\"DIM_PRODUIT\\\".\\\"LB_CATEGORIE\\\",    \\\"\"+context.schema_dwh+\"\\\".\\\"DIM_PRODUIT\\\".\\\"DT_INSERTION\\\",    \\\"\"+context.schema_dwh+\"\\\".\\\"DIM_PRODUIT\\\".\\\"DT_MISE_A_JOUR\\\",    \\\"\"+context.schema_dwh+\"\\\".\\\"DIM_PRODUIT\\\".\\\"BL_LIGNE_ACTIVE\\\",    \\\"\"+context.schema_dwh+\"\\\".\\\"DIM_PRODUIT\\\".\\\"LB_JOB_NAME\\\" FROM \\\"\"+context.schema_dwh+\"\\\".\\\"DIM_PRODUIT\\\"  WHERE \\\"BL_LIGNE_ACTIVE\\\"=1;  \"");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("USE_CURSOR" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_ALL_COLUMN" + " = " + "false");
                        log4jParamters_tDBInput_3.append(" | ");
                            log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("ID_DIM_PRODUIT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CD_PRODUIT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("NOM_PRODUIT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CD_SOUS_CATEGORIE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LB_SOUS_CATEGORIE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("CD_CATEGORIE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LB_CATEGORIE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DT_INSERTION")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("DT_MISE_A_JOUR")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("BL_LIGNE_ACTIVE")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LB_JOB_NAME")+"}]");
                        log4jParamters_tDBInput_3.append(" | ");
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_3", "     \"DIM_PRODUIT\"<br>       <b>tDBInput_3</b>", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
			}
        	...
        	row3.CD_SOUS_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_3, 4, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 5) {
								row3.LB_SOUS_CATEGORIE = null;
							} else {
	                         		
        	row3.LB_SOUS_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_3, 5, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 6) {
								row3.CD_CATEGORIE = null;
							} else {
	                         		
        	row3.CD_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_3, 6, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 7) {
								row3.LB_CATEGORIE = null;
							} else {
	                         		
        	row3.LB_CATEGORIE = routines.system.JDBCUtil.getString(rs_tDBInput_3, 7, false);
		                    }
							if(colQtyInRs_tDBInput_3 < 8) {
								row3.DT_INSERTION = null;
							} else {
										
			row3.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_3, 8);
		                    }
							if(colQtyInRs_tDBInput_3 < 9) {
								row3.DT_MISE_A_JOUR = null;
							} else {
										
			row3.DT_MISE_A_JOUR = routines.system.JDBCUtil.getDate(rs_tDBInput_3, 9);
		                    }
							if(colQtyInRs_tDBInput_3 < 10) {
								row3.BL_LIGNE_ACTIVE = 0;
							} else {
		                          
            row3.BL_LIGNE_ACTIVE = rs_tDBInput_3.getInt(10);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row3.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_3, 11, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row3","tDBInput_3","     \"DIM_PRODUIT\"<br>       <b>tDBInput_3</b>","tPostgresqlInput","tAdvancedHash_row3","tAdvancedHash_row3","tAdvancedHash"
...
tHash_Lookup_row3.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row3",2,0,
			 			"tDBInput_3","     \"DIM_PRODUIT\"<br>       <b>tDBInput_3</b>","tPostgresqlInput","tAdvancedHash_row3","tAdvancedHash_row3","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
	...
	currentComponent="tDBInput_4";
			...
			cLabel="\"ODS_CATEGORIE\"<br>      <b>tDBInput_4</b>";
		...
		int tos_count_tDBInput_4 = 0;
			...
			if(enableLogStash) {
				talendJobLog.addCM("tDBInput_4", "\"ODS_CATEGORIE\"<br>      <b>tDBInput_4</b>", "tPostgresqlInput");
				talendJobLogProcess(globalMap);
			}
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row4","tDBInput_4","\"ODS_CATEGORIE\"<br>      <b>tDBInput_4</b>","tPostgresqlInput","tAdvancedHash_row4","tAdvancedHash_row4","tAdvancedHash"
...
tHash_Lookup_row4.endPut();
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row4",2,0,
			 			"tDBInput_4","\"ODS_CATEGORIE\"<br>      <b>tDBInput_4</b>","tPostgresqlInput","tAdvancedHash_row4","tAdvancedHash_row4","tAdvancedHash","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
    ...
    public static void main(String[] args){
        ...
        int exitCode = jDwhProduitClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'jDwhProduit' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'jDwhProduit' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_kqaywCx4Ee69aJNa5n3Vgg");
                org.slf4j.MDC.put("_compiledAtTimestamp","2023-07-28T12:58:50.657870100Z");
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'jDwhProduit' - Started.");
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'jDwhProduit' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     420215 characters generated by Talend Cloud Data Fabric 
 *     on the July 28, 2023 at 2:58:50 PM CEST
 ************************************************************************************************/